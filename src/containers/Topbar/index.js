...
function handleMenuClick(e) {
  message.info("You are clicked ");
  console.log('click', e);
}

const menu = (
  <Menu onClick={handleMenuClick}>
    <Menu.Item key="new agent">New agent</Menu.Item>
    <Menu.Item key="new company">New company</Menu.Item>
    <Menu.Item key="new contact">New contact</Menu.Item>
    <Menu.Item key="new ticket">New ticket</Menu.Item>
  </Menu>
);
      ...
      <Auxiliary>
        <Header>
          ...
          <ul className="gx-header-notifications gx-ml-auto">
            <li className="gx-d-inline-block">
